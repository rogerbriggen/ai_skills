...
`glab mr view` shows MR metadata (title, author, branches, state).
`glab mr diff` shows the full diff in unified diff format. Skip to step 8.
...
7. For each file in the changes:
